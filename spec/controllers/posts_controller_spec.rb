...
# Member users modifying another user's post
  context "member modifying another user's post" do
    before do
...
# Member users modifying their own post
  context "member modifying their post" do
    before do
    ...
    describe "GET #edit" do
      ...
      it "assign post to be updated to @post" do
        get :edit, {topic_id: my_topic.id, id: my_post.id}
