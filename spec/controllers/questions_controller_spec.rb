...
RSpec.describe QuestionsController, type: :controller do
  let(:my_question) {Question.create!(title: RandomData.random_sentence,
    body: RandomData.random_paragraph, resolved: [true, false].sample)}
  ...
  describe "GET #index" do
    ...
    it "assign [my_question] to the @questions" do
      get :index
  ...
  describe "POST #create" do
    it "increases the number of Question by 1" do
      expect{
        post :create,
        question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: [true, false].sample}
  ...
  describe "PUT #update" do
    it "updates question with expected attributes" do
      ...
      new_bool  = [true, false].sample

      put :update,
      {id: my_question.id, question: {title: new_title, body: new_body, resolved: new_bool}}
      updated_question = assigns(:question)

      expect(updated_question.id).to eq(my_question.id)
      expect(updated_question.title).to eq(new_title)
      expect(updated_question.body).to eq(new_body)
      expect(updated_question.resolved).to eq(new_bool)
    end
    it "redirects to the updated question" do
      ...
      put :update,
      {id: my_question.id, question: {title: new_title, body: new_bool, resolved: new_bool}}
      updated_question = assigns(:question)
